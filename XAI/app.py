...
# # import asyncio
# # # from main import LogicModel
# # from main_new_version import LogicModel
# # from pyngrok import conf, ngrok
# # conf.get_default().auth_token = "2wLucPP7wlGTXHzR7vsQPUcsiJn_5DmDiaRR9pC4MFqd3bGHV"
# # # ----------------------
...
# # # ----------------------
# # def dummy_reasoning(premises: List[str], questions: str, model):
...
# #     # public_url = ngrok.connect(addr=43210, domain="magical-wise-toucan.ngrok-free.app")

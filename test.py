...
class nl_to_fol:
    def __init__(self, base_model, finetune_model, prompt_template_path, max_output_len, tokenizer, load_in_8bit=True, device=0):
    ...
    def generate_sentence(self, list_sentence):
        batch_simple_generate = self.data_preparer()
...
predicate_list = [
    "maintains gpa above 3.5",
    "completed a thesis",
    "qualify for the graduate fellowship program",
    "is eligible for graduation",
    "graduate with honors",
    "receives academic distinction",
...
if __name__=="__main__":
    ...
    predicate_list = [
        "does not engage in training",
        "inability to receive a qualification",
        "meets the requirements",
        "receive a qualification",
        "inability to engage in training",
        "completes prerequisite courses",
        "inability to conduct research",
        "engages in independent learning",
        "does not meet the requirements",
        "inability to meet the requirements",
        "are able to conduct research",
        "engages in training",
        "meet the requirements",
        "is eligible for advanced training"
    ]
    args = get_args()
    ...
    pred_fols = module_1.generate_sentence(predicate_list)
    for pred in pred_fols:
        print(pred)
